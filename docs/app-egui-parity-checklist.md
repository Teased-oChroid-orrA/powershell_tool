...
| 6-phase Design System Epic (tokens/typography/spacing/radii/shadows modules + bundled fonts; Button/Select/Tooltip/EmptyState/Toast/Segmented-control components; real light theme + icon system swap; command-palette/motion/focus-state polish; hardening) | OPEN - approved, not yet started |
