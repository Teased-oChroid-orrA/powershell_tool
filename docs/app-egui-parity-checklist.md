...
| Design System Epic Phases 3-6 (real light theme + icon system swap + elevation everywhere; command-palette/motion/focus-state polish; hardening/verification) | OPEN - approved, not yet started |
