...
| Design System Epic Phases 2-6 (Button/Select/Tooltip/EmptyState/Toast/Segmented-control components; real light theme + icon system swap; command-palette/motion/focus-state polish; hardening/verification) | OPEN - approved, not yet started |
